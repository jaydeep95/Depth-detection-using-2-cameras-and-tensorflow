...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:# JD A Session object encapsulates the environment in which Operation objects are executed, and Tensor objects are evaluated
    while True:
